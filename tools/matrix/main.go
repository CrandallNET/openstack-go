...
func coreReadPackages() map[string]string {
	packages := map[string]string{
		...
		"aggregate add host":                     "github.com/gophercloud/gophercloud/v2/openstack/compute/v2/aggregates",
		"aggregate cache image":                  "Nova aggregate image cache via gophercloud.ServiceClient; no typed Gophercloud helper in v2.12.0",
		"aggregate create":                       "github.com/gophercloud/gophercloud/v2/openstack/compute/v2/aggregates",
		"aggregate delete":                       "github.com/gophercloud/gophercloud/v2/openstack/compute/v2/aggregates",
		"aggregate list":                         "github.com/gophercloud/gophercloud/v2/openstack/compute/v2/aggregates",
		"aggregate remove host":                  "github.com/gophercloud/gophercloud/v2/openstack/compute/v2/aggregates",
		"aggregate set":                          "github.com/gophercloud/gophercloud/v2/openstack/compute/v2/aggregates",
		"aggregate show":                         "github.com/gophercloud/gophercloud/v2/openstack/compute/v2/aggregates",
		"aggregate unset":                        "github.com/gophercloud/gophercloud/v2/openstack/compute/v2/aggregates",
		...
		"compute agent create":                   "Nova os-agents via gophercloud.ServiceClient; OpenStackSDK intentionally does not support the deprecated API",
		"compute agent delete":                   "Nova os-agents via gophercloud.ServiceClient; OpenStackSDK intentionally does not support the deprecated API",
		...
		"compute agent set":                      "Nova os-agents via gophercloud.ServiceClient; OpenStackSDK intentionally does not support the deprecated API",
		"compute service delete":                 "github.com/gophercloud/gophercloud/v2/openstack/compute/v2/services",
		"compute service list":                   "github.com/gophercloud/gophercloud/v2/openstack/compute/v2/services",
		"compute service set":                    "github.com/gophercloud/gophercloud/v2/openstack/compute/v2/services",
		...
		"host set":                               "Nova os-hosts via gophercloud.ServiceClient; OpenStackSDK intentionally does not support the deprecated API",
		...
		"resource class create":                  "github.com/gophercloud/gophercloud/v2/openstack/placement/v1/resourceclasses",
		"resource class delete":                  "github.com/gophercloud/gophercloud/v2/openstack/placement/v1/resourceclasses",
		"resource class list":                    "github.com/gophercloud/gophercloud/v2/openstack/placement/v1/resourceclasses",
		"resource class set":                     "github.com/gophercloud/gophercloud/v2/openstack/placement/v1/resourceclasses",
		...
		"resource provider aggregate set":        "github.com/gophercloud/gophercloud/v2/openstack/placement/v1/resourceproviders",
		"resource provider allocation delete":    "Placement consumer allocations via gophercloud.ServiceClient; no typed Gophercloud helper in v2.12.0",
		"resource provider allocation set":       "Placement consumer allocations via gophercloud.ServiceClient; no typed Gophercloud helper in v2.12.0",
		"resource provider allocation show":      "Placement consumer allocations via gophercloud.ServiceClient; no typed Gophercloud helper in v2.12.0",
		"resource provider allocation unset":     "Placement consumer allocations via gophercloud.ServiceClient; no typed Gophercloud helper in v2.12.0",
		"resource provider create":               "github.com/gophercloud/gophercloud/v2/openstack/placement/v1/resourceproviders",
		"resource provider delete":               "github.com/gophercloud/gophercloud/v2/openstack/placement/v1/resourceproviders",
		"resource provider inventory class set":  "github.com/gophercloud/gophercloud/v2/openstack/placement/v1/resourceproviders; raw request preserves partial OSC inventory payloads",
		"resource provider inventory delete":     "github.com/gophercloud/gophercloud/v2/openstack/placement/v1/resourceproviders",
		"resource provider inventory list":       "github.com/gophercloud/gophercloud/v2/openstack/placement/v1/resourceproviders",
		"resource provider inventory set":        "github.com/gophercloud/gophercloud/v2/openstack/placement/v1/resourceproviders; raw request preserves partial OSC inventory payloads",
		...
		"resource provider set":                  "github.com/gophercloud/gophercloud/v2/openstack/placement/v1/resourceproviders",
		"resource provider show":                 "github.com/gophercloud/gophercloud/v2/openstack/placement/v1/resourceproviders",
		"resource provider trait delete":         "github.com/gophercloud/gophercloud/v2/openstack/placement/v1/resourceproviders",
		"resource provider trait list":           "github.com/gophercloud/gophercloud/v2/openstack/placement/v1/resourceproviders",
		"resource provider trait set":            "github.com/gophercloud/gophercloud/v2/openstack/placement/v1/resourceproviders",
		"resource provider usage show":           "github.com/gophercloud/gophercloud/v2/openstack/placement/v1/resourceproviders",
		"resource usage show":                    "Placement project/user usages via gophercloud.ServiceClient; no typed Gophercloud helper in v2.12.0",
		...
		"trait create":                           "github.com/gophercloud/gophercloud/v2/openstack/placement/v1/traits",
		"trait delete":                           "github.com/gophercloud/gophercloud/v2/openstack/placement/v1/traits",
...
func coreReadShims() map[string]bool {
	shims := map[string]bool{
		...
		"aggregate cache image":                  true,
		"compute agent create":                   true,
		"compute agent delete":                   true,
		"compute agent list":                     true,
		"compute agent set":                      true,
		...
		"quota set":                              true,
		"quota show":                             true,
		"resource provider allocation delete":    true,
		"resource provider allocation set":       true,
		"resource provider allocation show":      true,
		"resource provider allocation unset":     true,
		"resource provider inventory class set":  true,
		"resource provider inventory set":        true,
		"resource usage show":                    true,
...
func coreWriteCommands() map[string]bool {
	return map[string]bool{
		"aggregate add host":                             true,
		"aggregate cache image":                          true,
		"aggregate create":                               true,
		"aggregate delete":                               true,
		"aggregate remove host":                          true,
		"aggregate set":                                  true,
		...
		"compute agent delete":                           true,
		"compute agent set":                              true,
		"compute service delete":                         true,
		"compute service set":                            true,
		"image add project":                              true,
		"container create":                               true,
		"container delete":                               true,
		"container save":                                 true,
		...
		"quota delete":                                   true,
		"quota set":                                      true,
		"resource class create":                          true,
		"resource class delete":                          true,
		"resource class set":                             true,
		"resource provider aggregate set":                true,
		"resource provider allocation delete":            true,
		"resource provider allocation set":               true,
		"resource provider allocation unset":             true,
		"resource provider create":                       true,
		"resource provider delete":                       true,
		"resource provider inventory class set":          true,
		"resource provider inventory delete":             true,
		"resource provider inventory set":                true,
		"resource provider set":                          true,
		"resource provider trait delete":                 true,
		"resource provider trait set":                    true,
		"router add gateway":                             true,
		"router add port":                                true,
		"router add route":                               true,
		"router add subnet":                              true,
